    ...
    return (
        <div className="min-h-screen w-full flex justify-center dark:bg-zinc-900 h-fit bg-red-200">
            <div id="mainBox" className='min-w-fit h-fit w-2/5 text-lg p-2 text-center my-10'>
                ...
                <Link to={"/"}><button onClick={playSound} className='w-full shadow-xl bg-[#f9f8b0] dark:bg-gray-800 hover:dark:bg-gray-900 dark:border-[#727272] hover:dark:border-white mt-16 hover:scale-105 transition hover:transition rounded-xl border-4 dark:text-cyan-500 border-black py-2'><i className="ri-home-2-fill text-5xl"></i></button></Link>
                <Link to={"/game"}><button onClick={playSound} className='w-full shadow-xl bg-[#f9f8b0] mt-5 mb-10 hover:scale-105 transition hover:transition dark:border-[#727272] rounded-xl dark:bg-gray-800 hover:dark:bg-gray-900 hover:dark:border-white dark:text-cyan-500 border-4 border-black py-2'><i className="ri-restart-line text-5xl"></i></button></Link>
