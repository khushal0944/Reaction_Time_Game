...
export default function GameOver(){
    ...
    return (
        <div className="min-h-screen w-full anime flex justify-center h-fit bg-red-200">
            <div id="mainBox" className='divide-black min-w-fit h-fit w-2/5 text-lg p-2 text-center my-10'>
                ...
                <Link to={"/"}><button className='w-full shadow-xl bg-[#f9f8b0] mt-16 hover:scale-105 transition hover:transition rounded-xl border-4 border-black py-2'><i className="ri-home-2-fill text-5xl"></i></button></Link>
                <Link to={"/game"}><button className='w-full shadow-xl bg-[#f9f8b0] mt-5 mb-10 hover:scale-105 transition hover:transition rounded-xl border-4 border-black py-2'><i className="ri-restart-line text-5xl"></i></button></Link>
                <hr />
            </div>
        </div>
    )
